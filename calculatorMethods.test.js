...
it("clear-2", () => {
    ...
    expect(obj.currentOperand).toEqual('');
    expect(obj.previousOperand).toEqual('');
    expect(obj.operation).toEqual(undefined);
...
it("appendNumber", () => {
  ...
  currentOperand = appendNumber(obj, 1);
  expect(currentOperand).toEqual("21");
  expect(obj.currentOperand).toEqual("21");
